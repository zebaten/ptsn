<?php
  ...
  $sql2 = "SELECT h.Hab_Nombre, s.Temperatura, s.Humedad_Relativa, s.Sens_Fecha_Hora FROM Casa c, Habitacion h, Sensor s 
  WHERE c.Casa_Id = '$id' AND c.Casa_Id = h.Casa_Id AND h.Habitacion_Id = s.Habitacion_Id";
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="admin_historiales.php">Historiales</a>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="row table-responsive">
          ...
          <tbody>
						<?php while($row2 = $resultado2->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
              <td><?php echo $row2['Hab_Nombre']; ?></td>
								<td><?php echo $row2['Temperatura']; ?></td>
                <td><?php echo $row2['Humedad_Relativa']; ?></td>
                <td><?php echo $row2['Sens_Fecha_Hora']; ?></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
