<?php
  ...
  $sql = "SELECT Usuario_Id FROM Usuario WHERE Usuario_Correo = '$usuarioingresado'";
  $resultado = $mysqli->query($sql);
	$row = $resultado->fetch_array(MYSQLI_ASSOC);

  $sql1 = "SELECT * FROM Casa WHERE Usuario_Id = '". $row['Usuario_Id'] ."'";
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="hist_habit_casa.php">Historial Habitaciones</a>
                    </li>
