...
$sql = "SELECT h.Hab_Nombre, c.Casa_Calle, c.Casa_Numero, cm.Comuna_Nombre, r.Region_Nombre, s.Humedad_Relativa, s.Temperatura, s.Sens_Fecha_Hora 
FROM Casa c, Habitacion h, Comuna cm, Region r, Sensor s 
WHERE r.Region_Id = cm.Region_Id AND cm.Comuna_Id = c.Comuna_Id AND c.Casa_Id = h.Casa_Id AND h.Habitacion_Id = s.Habitacion_Id";
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="reg_home.php">Home</a>
                    </li>
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="historiales_reg.php">Historiales</a>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="row table-responsive">
          ...
          <tbody>
              ...
              <td><?php echo $row['Hab_Nombre']; ?></td>
								<td><?php echo $row['Casa_Calle'],' ', $row['Casa_Numero']; ?></td>
                <td><?php echo $row['Comuna_Nombre']; ?></td>
                <td><?php echo $row['Region_Nombre']; ?></td>
								<td><?php echo $row['Temperatura']; ?></td>
                <td><?php echo $row['Humedad_Relativa']; ?></td>
                <td><?php echo $row['Sens_Fecha_Hora']; ?></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
