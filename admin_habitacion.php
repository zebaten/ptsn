<?php
  ...
  $sql = "SELECT * FROM Habitacion WHERE Casa_Id = '$id'";
  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="container">
        ...
        <a href="habitacion/habitacion_add.php?Id=<?php echo $id; ?>" type="button" class="btn btn-primary-12" data-toggle="modal" data-target="#exampleModalCenterCasa">Nuevo Registro</a>
        ...
        <div class="row table-responsive">
          ...
          <tbody>
                ...
                <td><?php echo $row['Hab_Nombre']; ?></td>
								<td><a href="habitacion/habitacion_edit.php?Habitacion_Id=<?php echo $row['Habitacion_Id']; ?>"><i class="fa-solid fa-pencil"></i></a></td>
								<td><a href="#" data-href="habitacion/habitacion_delete.php?Habitacion_Id=<?php echo $row['Habitacion_Id']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa-solid fa-trash"></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
